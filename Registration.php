        ...
        <form action="RegistrationHandler.php" method="post" enctype="multipart/form-data">
            ...
            <div class="content">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Enter your NIC Number" id =  "txtNic" name = "txtNic" required>
                </div>
                ...
                <div class="input-box">
                    ...
                    <input type="tel" placeholder="Enter phone number" id = "txtPhone" name = "txtPhone" maxlength="10" required>
                </div>
                <div class="input-box">
            ...
            <div class="alert">
                ...
                <button type = "submit" id = "Submitbtn" name = "Submitbtn" class = "Submitbtn">Register</button>   
        </form>
    </div>
